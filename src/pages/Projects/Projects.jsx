...
//       root
//       options={{
//         lerp: 0.05, // Lower value for slower, smoother scrolling
//         duration: 1.5, // Duration of scroll animation
//         smooth: true, // Enable smooth scrolling
//       }}
//     >
//       <main className="bg-black pt-24" ref={container}>
//         <section className="text-white w-full bg-slate-950 py-16">
...
// }) {
//   return (
//     <div className="w-full flex items-center justify-center project-container">
//       <motion.div
//         className="w-[90%] md:w-[85%] lg:w-[75%] xl:w-[65%] project-card"
//         whileHover={{
//           y: -8,
//           transition: { duration: 0.3 },
//         }}
...
export default function Projects() {
  ...
  return (
    <ReactLenis
      root
      options={{
        lerp: 0.08, // Slightly higher lerp for smoother scrolling
        duration: 2.0, // Increased duration for slower scroll
        smooth: true, // Enable smooth scrolling
  ...
  return (
    <div className="w-full flex items-center justify-center project-container">
      ...
      >
        ...
        <div className="w-full flex flex-col md:flex-row bg-zinc-900 rounded-2xl overflow-hidden shadow-xl">
          {/* Image section - full width on mobile, 55% on desktop */}
          <div className="w-full md:w-[55%] h-[200px] md:h-[300px] lg:h-[350px] relative overflow-hidden">
            <motion.img
              src={url}
              alt={title}
...
Card.propTypes = {
  ...
  color: PropTypes.string.isRequired,
  githubLink: PropTypes.string.isRequired,
  liveLink: PropTypes.string, // Made optional
};