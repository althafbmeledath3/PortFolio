...
const profile = {
    ...
    skills: [
        'React', 'Node Js', 'RestAPI', 'Express',
        'Multer', 'MongoDB', 'AWS', 'JavaScript',
        'axios', 'Git', 'Responsive Web Design', 'JWT'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
...
Althaf B Meledath                    </span>
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                ...
                MERN Stack Lover 💚 | Python 🐍 | Code  💻 | Building the Future, One Line at a Time 🚀
